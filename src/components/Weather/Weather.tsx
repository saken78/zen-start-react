...
import { Cloud, CloudRain, Sun, CloudSnow, CloudLightning, AlertCircle } from "lucide-react";
...
export const Weather: React.FC = () => {
  ...
  const getWeatherIcon = (condition: string): React.ReactNode => {
    ...
    if (conditionLower.includes("drizzle") || conditionLower.includes("rain")) {
  ...
  return (
    ...
    >
      ...
      <span className='text-text text-xs font-bold'>{convertTemp(weather.temperature)}</span>
